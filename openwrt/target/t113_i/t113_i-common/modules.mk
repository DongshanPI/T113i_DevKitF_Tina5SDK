...
define KernelPackage/net-xr829
  SUBMENU:=$(WIRELESS_MENU)
  TITLE:=xr829 support (staging)
  DEPENDS:= +xr829-firmware +@IPV6 +@USES_XR829 +@PACKAGE_xr829-rftest
  KCONFIG:=\
	CONFIG_XR829_WLAN=m \
	CONFIG_PM=y\
	CONFIG_BT=y \
...
define KernelPackage/net-xr819s-40M
  ...
  FILES:=$(LINUX_DIR)/drivers/net/wireless/xr819/wireless_switch/wireless_switch.ko
  FILES+=$(LINUX_DIR)/drivers/net/wireless/xr819/xr819.ko
  AUTOLOAD:=$(call AutoProbe, wireless_switch, xr819)
endef
