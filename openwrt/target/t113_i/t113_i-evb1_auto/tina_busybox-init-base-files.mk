############################################################################################
# 			t113-evb1 busybox-init-base-files for tina(OpenWrt) Linux
#
#	t113-evb1 busybox-init-base-files will generate shell script according to some 
...
all:
	@echo ==================================================
	@echo target/allwinner/t113-evb1/tina_busybox-init-basefiles.mk is called to generate shell scripts
	@echo ==================================================
...
clean:
	@echo ==================================================
	@echo target/allwinner/t113-evb1/tina_busybox-init-basefiles.mk is called to clean shell scripts
	@echo ==================================================
