...
#define FTS_CHIP_MC_SC          ((FTS_CHIP_TYPE & FLAGBIT(FLAG_MC_SC_BIT)) == FLAGBIT(FLAG_MC_SC_BIT))
#define FTS_CHIP_SC             ((FTS_CHIP_TYPE & FLAGBIT(FLAG_SC_BIT)) == FLAGBIT(FLAG_SC_BIT))
#ifndef FTS_HID_SUPPORTTED
#define FTS_HID_SUPPORTTED      ((FTS_CHIP_TYPE & FLAGBIT(FLAG_HID_BIT)) == FLAGBIT(FLAG_HID_BIT))
#endif
#define FTS_NEW_CLB_MODE        ((FTS_CHIP_TYPE & FLAGBIT(FLAG_CLB_BIT)) == FLAGBIT(FLAG_CLB_BIT))
#define FTS_GESTURE_SUPPORTED   ((FTS_CHIP_TYPE & FLAGBIT(FLAG_GESTURE_BIT)) == FLAGBIT(FLAG_GESTURE_BIT))
#define FTS_GLOVE_SUPPORTED     ((FTS_CHIP_TYPE & FLAGBIT(FLAG_GLOVE_BIT)) == FLAGBIT(FLAG_GLOVE_BIT))
